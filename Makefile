# This Makefile is for the Money::Chinese extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Money/Chinese.pm]
#     AUTHOR => q[A. U. Thor <a.u.thor@a.galaxy.far.far.away>]
#     NAME => q[Money::Chinese]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Money/Chinese.pm]
...
MAKE = make
FULLEXT = Money/Chinese
BASEEXT = Chinese
PARENT_NAME = Money
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Money/Chinese.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Money/Chinese.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Money
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Money
...
TO_INST_PM = lib/Money/Chinese.pm

PM_TO_BLIB = lib/Money/Chinese.pm \
...
DISTNAME = Money-Chinese
DISTVNAME = Money-Chinese-1.04
...
manifypods : pure_all  \
	lib/Money/Chinese.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Money/Chinese.pm $(INST_MAN3DIR)/Money.Chinese.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Money-Chinese' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            1.04' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           Perl extension for blah blah blah' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="cygwin-thread-multi-64int-5.10" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Money/Chinese.pm blib/lib/Money/Chinese.pm 
